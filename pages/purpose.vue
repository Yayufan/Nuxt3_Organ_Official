...
let initialSupervisorsList = reactive<Supervisor[]>([
    {
        ...
        chairman: '葉高芳',
        executiveDirector: '周天瑞、黃明義、魏  崢、蘇宜三',
        director: '賴明坤、連榮達、朱樹勳、林孝義、易長筠、蘇培人、陳武宗、嚴  道、周昌德、秦  燕、孫  鉞',
    ...
    },
    {
        ...
        chairman: '魏  崢',
        executiveDirector: '葉高芳、嚴  道、黃桂福、黃明義',
        director: '賴明坤、蘇培人、林孝義、朱樹勳、孫  鉞、連榮達、江淇松、周昌德、周天瑞、陳武宗',
    ...
    },
    {
        ...
        chairman: '賴明坤',
        executiveDirector: '魏  崢、嚴  道、黃明義、 連榮達',
    ...
    },
    {
        ...
        chairman: '鄭隆賓',
        executiveDirector: '魏  崢、賴明坤、連榮達、侯靜蘭',
...
let otherSupervisorsList = reactive<Supervisor[]>([
    ...
    },
    {
        ...
        chairman: '龍藉泉',
        executiveDirector: '魏  崢、張忠毅、張奇香、謝輝和',
    ...
    },
    {
        ...
        chairman: '張忠毅',
        executiveDirector: '魏  崢、蔡建松、張奇香、王志文',
    ...
    },
    {
        ...
        director: '魏  崢、邱亦宣、江仰仁、陳靜陵、鄭麗容、呂金春、張龍雄、顏俊輝、劉美蓮、蔡建松、王植熙、謝宗保',
    ...
    },
    {
        ...
        director: '魏  崢、張奇香、白金川、李芳艷、陳靜陵、鄭麗容、簡鑠驊、陳淑玲、鍾孟軒、蔡長穎、吳沅衿、紀炳宏',
        executiveSupervisor: '韓月英',
...
// 實際顯示用的列表
let supervisorsList = reactive<Supervisor[]>([...initialSupervisorsList])
...
const getOtherList = () => {
    if (!showFullList.value) {
        ...
        // 展開列表：加入剩餘資料
        supervisorsList.splice(initialSupervisorsList.length, 0, ...otherSupervisorsList)
        showFullList.value = true
    } else {
        // 縮減列表：移除額外資料
        supervisorsList.splice(initialSupervisorsList.length, otherSupervisorsList.length)
