    ...
    <div class="menu-section">
        ...
        <el-menu :class="['PC-navbar', { 'not-show-logo': !showLogo }]"  :ellipsis="false" mode="horizontal" @select="" :popper-offset="-1"
            ...
            <el-sub-menu index="1">
                ...
                <nuxt-link :to="'/association-chronology'"> <el-menu-item index="association-chronology">協會年表</el-menu-item></nuxt-link>
                <nuxt-link :to="'/achievements'"><el-menu-item index="achievements">歷年成果(簽卡分析)</el-menu-item></nuxt-link>
                <nuxt-link
                    :to="'https://www.facebook.com/organassociation/'"><el-menu-item index="facebook">臉書粉絲團</el-menu-item></nuxt-link>
            </el-sub-menu>
            ...
            <el-sub-menu index="3">
                ...
                <nuxt-link to="/story-donor-family"><el-menu-item index="story-donor-family">器捐生命故事:捐贈者家屬篇</el-menu-item></nuxt-link>
                <nuxt-link to="/story-recipient"><el-menu-item index="story-recipient">器捐生命故事:受捐者篇</el-menu-item></nuxt-link>
                <nuxt-link to="/video-area"><el-menu-item index="video-area">影音專區</el-menu-item></nuxt-link>
                <nuxt-link to="/brochure-download"><el-menu-item index="brochure-download">文宣下載</el-menu-item></nuxt-link>
            ...
            <el-sub-menu index="4">
                ...
                <nuxt-link :to="'/assistance-resources'"><el-menu-item index="assistance-resources">協助資源</el-menu-item></nuxt-link>
                <nuxt-link :to="'/book-recommendations'"><el-menu-item index="book-recommendations">好書推薦</el-menu-item></nuxt-link>
                <nuxt-link to="https://docs.google.com/forms/d/e/1FAIpQLScxrl0on7gvcaTYTI9knEgy0-dwGHhT7SeJfS183B8g811QHQ/viewform"><el-menu-item index="form">家屬資料填寫</el-menu-item></nuxt-link>
                <nuxt-link :to="'/social-work-column'"><el-menu-item index="social-work-column">社工專欄</el-menu-item></nuxt-link>
            ...
            <el-sub-menu index="5">
                ...
                <nuxt-link :to="'/charity-sale'"><el-menu-item index="charity-sale">版畫有限量，愛心無限亮</el-menu-item></nuxt-link>
            </el-sub-menu>
            <el-sub-menu index="6">
                <template #title>簽署器捐</template>
                <nuxt-link to="/sign-online"><el-menu-item index="sign-online">線上簽屬</el-menu-item></nuxt-link>
                <nuxt-link to="/frequently-asked-questions"><el-menu-item index="frequently-asked-questions">簽卡停看聽</el-menu-item></nuxt-link>
